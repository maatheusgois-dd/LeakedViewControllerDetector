...
class BasicTests: XCTestCase {
    ...
    func testIgnoredClassNames() {
        ...
        XCTAssertTrue(ignoredVCs.count > 0, "Should have ignored view controller classes")
        XCTAssertTrue(ignoredViews.count > 0, "Should have ignored view classes")
        XCTAssertTrue(ignoredWindows.count > 0, "Should have ignored window classes")
